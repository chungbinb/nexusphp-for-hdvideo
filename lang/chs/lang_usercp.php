...
(
	...
	'text_avatar_current' => "当前头像",
	'button_avatar_choose_file' => "上传新头像",
	'button_avatar_reset_default' => "恢复默认头像",
	'text_avatar_upload_note' => "支持 GIF、JPG、PNG，最大 256 KB；保存后会自动缩放为头像尺寸。",
	'text_avatar_upload_disabled' => "当前站点未开启头像上传。",
	'text_avatar_uploading' => "头像正在上传...",
	'text_avatar_uploaded' => "头像已上传，保存设定后生效。",
	'std_avatar_upload_disabled' => "当前站点未开启头像上传。",
	'std_avatar_upload_failed' => "头像上传失败，请重新选择图片。",
	'std_avatar_file_too_large' => "头像文件不能超过 256 KB。",
	'std_avatar_invalid_image' => "请上传 GIF、JPG 或 PNG 图片。",
	'std_avatar_processing_failed' => "头像图片处理失败，请换一张图片。",
	'std_avatar_invalid_server_file' => "选择的头像文件无效，请重新上传。",
	'std_avatar_wait_upload' => "请等待头像上传完成后再保存。",
	'row_info' => "个人说明",
	...
	'row_karma_points' => "电影票",
	'link_use_karma_points' => "使用电影票",
	...
	'text_buy_no_advertisement' => "及以上等级用户可用电影票兑换一定期限内不显示广告的权限，点击",
