...
(
	...
	'text_avatar_current' => "Current avatar",
	'button_avatar_choose_file' => "Upload new avatar",
	'button_avatar_reset_default' => "Use default avatar",
	'text_avatar_upload_note' => "GIF, JPG, or PNG. Max 256 KB. The image is resized for avatar display.",
	'text_avatar_upload_disabled' => "Avatar upload is disabled.",
	'text_avatar_uploading' => "Uploading avatar...",
	'text_avatar_uploaded' => "Avatar uploaded. Save settings to use it.",
	'std_avatar_upload_disabled' => "Avatar upload is disabled.",
	'std_avatar_upload_failed' => "Avatar upload failed. Please choose another image.",
	'std_avatar_file_too_large' => "Avatar file must be 256 KB or smaller.",
	'std_avatar_invalid_image' => "Please upload a GIF, JPG, or PNG image.",
	'std_avatar_processing_failed' => "Avatar image processing failed. Please choose another image.",
	'std_avatar_invalid_server_file' => "The selected avatar file is invalid. Please upload it again.",
	'std_avatar_wait_upload' => "Please wait until the avatar upload finishes.",
	'row_info' => "Info",
