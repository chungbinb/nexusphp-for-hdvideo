// #nav (the menu bar) is absolutely top-anchored; center it vertically so it matches the right side.
...
fs.writeFileSync(path.join(__dirname, `_backup_modern-refresh-vcenter2_${stamp}.css`), content, 'utf8');
...
console.log(v.includes(MARK) ? '>>> VERIFIED: #nav centered vertically.' : '>>> WARNING: verify.');
process.exit(0);
