...
.shop-orders-back{display:inline-flex;align-items:center;justify-content:center;padding:8px 13px;border-radius:8px;background:var(--bili-primary,#00aeec);color:#fff;text-decoration:none;font-weight:700;}
...
@media (max-width:760px){.shop-orders-table{display:block;overflow-x:auto}.shop-orders{padding:0 10px 70px;}}
</style>
