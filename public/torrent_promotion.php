...
.tp-form{padding:4px 24px 24px}.tp-fieldset{min-width:0!important;margin:0!important;padding:0!important;border:0!important}.tp-legend{display:block;width:100%;margin:0 0 10px;padding:0;color:var(--bili-text,#18191c);font-size:14px;font-weight:800}.tp-options{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px}.tp-option{position:relative;display:grid!important;grid-template-columns:32px minmax(0,1fr);grid-template-rows:auto auto 1fr;column-gap:12px;min-height:164px;padding:18px 52px 18px 18px;border:2px solid var(--bili-border,#e6e9ef);border-radius:12px;background:var(--bili-surface-soft,#f7f8fa);cursor:pointer;transition:border-color .18s,background .18s}
