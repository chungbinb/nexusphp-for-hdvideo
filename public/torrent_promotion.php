...
.tp-meta{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:10px;padding:18px 24px}.tp-meta div{padding:12px;border:1px solid var(--bili-border,#e6e9ef);border-radius:10px;background:var(--bili-surface-soft,#f7f8fa)}
...
.tp-form{padding:4px 24px 24px}.tp-options{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px}.tp-option{position:relative;display:block;min-height:150px;padding:18px;border:2px solid var(--bili-border,#e6e9ef);border-radius:12px;background:var(--bili-surface-soft,#f7f8fa);cursor:pointer;transition:border-color .18s,background .18s}
.tp-option:hover{border-color:var(--bili-primary,#00aeec)}.tp-option:has(input:checked){border-color:var(--bili-primary,#00aeec);background:color-mix(in srgb,var(--bili-primary,#00aeec) 9%,var(--bili-surface,#fff))}
.tp-option input{position:absolute;right:16px;top:16px;width:20px;height:20px;accent-color:var(--bili-primary,#00aeec)}.tp-icon{width:28px;height:28px;color:var(--bili-primary,#00aeec)}.tp-icon svg{width:100%;height:100%;fill:none;stroke:currentColor;stroke-width:2;stroke-linecap:round;stroke-linejoin:round}
.tp-option h2{margin:10px 0 5px!important;color:var(--bili-text,#18191c)!important;font-size:18px}.tp-option p{margin:0;color:var(--bili-text-secondary,#61666d);line-height:1.65}.tp-price{display:block;margin-top:10px;color:var(--bili-primary,#00aeec);font-weight:800}
.tp-total{display:flex;align-items:center;justify-content:space-between;gap:16px;margin-top:16px;padding:14px 16px;border-radius:10px;background:var(--bili-surface-soft,#f7f8fa)}.tp-total strong{color:var(--bili-primary,#00aeec);font-size:20px}
.tp-actions{display:flex;justify-content:flex-end;gap:10px;margin-top:16px}.tp-btn{min-height:44px;padding:0 20px;border-radius:9px;font-weight:800;cursor:pointer}.tp-back{display:inline-flex;align-items:center;border:1px solid var(--bili-border,#e6e9ef);background:var(--bili-surface,#fff);color:var(--bili-text,#18191c)!important}.tp-submit{border:1px solid var(--bili-primary,#00aeec);background:var(--bili-primary,#00aeec);color:#fff}.tp-submit:disabled{opacity:.5;cursor:not-allowed}
...
@media(max-width:640px){.tp-wrap{padding:0 12px}.tp-head,.tp-form{padding-left:16px;padding-right:16px}.tp-meta{grid-template-columns:1fr;padding:16px}.tp-options{grid-template-columns:1fr}.tp-actions{flex-direction:column-reverse}.tp-btn{width:100%}}
</style>
<main class="tp-wrap">
<section class="tp-card">
    ...
    <form method="post" class="tp-form" id="torrentPromotionForm">
        ...
        <fieldset style="margin:0;padding:0;border:0"><legend class="sr-only">选择推广功能</legend><div class="tp-options">
